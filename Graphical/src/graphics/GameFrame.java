		...
		if(GameManager.GetCurrentMechanic() == null && GameManager.GetCurrentSaboteur() != null)
		{
			for(JButton butt: actionButtons)
			{
				if(butt.getText().equals("repair") || butt.getText().equals("droppump")
						...
						|| butt.getText().equals("pickfreepipe") || butt.getText().equals("picknewpump") ||butt.getText().equals("pickneighbour X") )
	...
	public void setInventory()
	{
		if(GameManager.GetCurrentMechanic() != null) 
		{
			...
			if(GameManager.GetCurrentMechanic().GetPipeInInventory() != null)
				pipeText.setText("Van cső a játékosnál: " + GameManager.GetCurrentMechanic().GetPipeInInventory().GetId() + " bekötve: " + GameManager.GetCurrentMechanic().GetPipeInInventory().GetNeighbours().get(0).GetId());
			else
				pipeText.setText("Nincs cső a játékosnál");

			if(GameManager.GetCurrentMechanic().GetPumpInInventory() != null)
				pumpText.setText("Van pumpa a játékosnál: " + GameManager.GetCurrentMechanic().GetPumpInInventory().GetId());
			else
