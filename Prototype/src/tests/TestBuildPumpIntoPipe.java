...
public class TestBuildPumpIntoPipe extends TestBase
{
    ...
    {
    	System.out.println("\nTryTestBuildPumpWithWaterFlow Test");
        ...
        spring.GetNeighbours().get(0).Step();
        pump2.Step();
        pump2.Step();
        pipe1.Step();
        pump.Step();
        ...
        pipe2.Step();
        cistern.Step();
        System.out.println("\nA léptetés után az aktív elemekben a következő a vízmennyiség: ");
		...
		System.out.println(cistern.GetWaterInside() == 1 ? "Egyformák\nSikeres teszt!" : "Nem egyformák\nNem sikeres a teszt!");
    }
}